 ...
 * Build: http://modernizr.com/download/#-backgroundsize-csstransitions-inlinesvg-svg-svgclippaths-touch-shiv-mq-cssclasses-teststyles-testprop-testallprops-prefixes-domprefixes-load
 */
window.Modernizr = function(e, t, n) {
  ...
  var l = "2.6.2",
    ...
    M = function(t) {
      ...
      var r;
      return O("@media " + t + " { #" + d + " { position: absolute; } }", function(t) {
  ...
  !s(_, "undefined") && !s(_.call, "undefined") ? D = function(e, t) {
    ...
    return !!t.createElementNS && /SVGClipPath/.test(y.call(t.createElementNS(x.svg, "clipPath")))
  };
  ...
  return c.addTest = function(e, t) {
    ...
    e.html5 = g, a(t)
  }(this, t), c._version = l, c._prefixes = b, c._domPrefixes = S, c._cssomPrefixes = E, c.mq = M, c.testProp = function(e) {
    return u([e])
