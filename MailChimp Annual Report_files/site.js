...
(function(e, t) {
  ...
  }, Y.event.handle = Y.event.dispatch, Y.removeEvent = R.removeEventListener ?
  function(e, t, n) {
  ...
  Zt.optgroup = Zt.option, Zt.tbody = Zt.tfoot = Zt.colgroup = Zt.caption = Zt.thead, Zt.th = Zt.td, Y.support.htmlSerialize || (Zt._default = [1, "X<div>", "</div>"]), Y.fn.extend({
    ...
    remove: function(e, t) {
      var n, r = 0;
      for (;
      (n = this[r]) != null; r++) if (!e || Y.filter(e, [n]).length)!t && n.nodeType === 1 && (Y.cleanData(n.getElementsByTagName("*")), Y.cleanData([n])), n.parentNode && n.parentNode.removeChild(n);
      return this
    },
    empty: function() {
      var e, t = 0;
    ...
    clean: function(e, t, n, r) {
      ...
      if (n) {
        ...
        for (i = 0;
        (o = b[i]) != null; i++) if (!Y.nodeName(o, "script") || !m(o)) n.appendChild(o), typeof o.getElementsByTagName != "undefined" && (g = Y.grep(Y.merge([], o.getElementsByTagName("script")), m), b.splice.apply(b, [i + 1, 0].concat(g)), i += g.length)
      }
      return b
    },
    cleanData: function(e, t) {
      var n, r, i, s, o = 0,
        ...
        l = Y.event.special;
      for (;
      (i = e[o]) != null; o++) if (t || Y.acceptData(i)) {
        r = i[u], n = r && a[r];
        if (n) {
      ...
      "*": [function(e, t) {
        ...
        if (s) {
          ...
          if (r !== "px" && u) {
            ...
            do a = a || ".5", u /= a, Y.style(i.elem, e, u + r);
      ...
      init: function(r, i) {
        return this.each(function() {
          ...
          function() {
            ...
            offset: null,
            options: v
          }) : u.waypoints[p].options = v, r && h.bind(o, r), i && i.handler && h.bind(o, i.handler)
        }), e[n]("refresh"), this
      },
      remove: function() {
...
}(jQuery, "waypoint", "waypoints", window), jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
  def: "easeOutQuad",
  ...
  function h(e) {
    ...
    for (t = 0, n = e.length; t < n; ++t) {
      a(e[t], "array") || (e[t] = String(e[t]).match(/(?:\+\/|[^\/])+/g)), o = [], r = e[t].length;
      while (r--) {
        var u = e[t][r];
        s = {
          ...
          altKey: !1,
          metaKey: !1
        }, a(u, "array") || (u = String(u).toLowerCase().match(/(?:(?:[^\+])+|\+\+|^\+$)/g)), i = u.length;
        while (i--) u[i] === "++" && (u[i] = "+"), u[i] in l.mods ? s[f[l.mods[u[i]]]] = !0 : u[i] in l.keys ? s.keyCode = l.keys[u[i]] : c = u[i].match(/^\[([^-]+\-?[^-]*)-([^-]+\-?[^-]*)\]$/);
        if (a(s.keyCode, "undefined")) if (c && c[1] in l.keys && c[2] in l.keys) {
          c[2] = l.keys[c[2]], c[1] = l.keys[c[1]];
          for (p = c[1]; p < c[2]; ++p) o.push({
            altKey: s.altKey,
            shiftKey: s.shiftKey,
            metaKey: s.metaKey,
            ctrlKey: s.ctrlKey,
  ...
  c = 95, n = 0;
  while (++c < 106) l.keys["num-" + n] = c, ++n;
  c = 47, n = 0;
  while (++c < 58) l.keys[n] = c, ++n;
  c = 111, n = 1;
  while (++c < 136) l.keys["f" + n] = c, ++n;
  var c = 64;
  while (++c < 91) l.keys[String.fromCharCode(c).toLowerCase()] = c;
  var p = t.jwerty = {
    event: function(e, t, n) {
      ...
      return function(r) {
        if (u = p.is(e, r, i)) {
          ...
          o = t.call(n || this, r, u), o === !1 && r.preventDefault(), i = 0;
          return
        }
        i = p.is(e, r) ? 1 : 0
      }
    ...
    is: function(e, t, n) {
      e = new h(e), n = n || 0, e = e[n], t = t.originalEvent || t;
      var r, i = e.length,
        s = !1;
      while (i--) {
        s = e[i].jwertyCombo;
        for (var o in e[i]) o !== "jwertyCombo" && t[o] != e[i][o] && (s = !1);
        if (s !== !1) return s
      }
      return s
    },
...
}(this, typeof module != "undefined" && module.exports ? module.exports : this), function() {
  window.$$ = {
    version: "0.1",
    sections: [],
    ...
    animate_background: function(e, t) {
      var n, r;
      n = $$.sections[e].color, r = $(".section").eq(e), Modernizr.csstransitions ? $(".bg-image.show").removeClass("show") : $(".bg-image.show").hide(), r.hasClass("image") && (Modernizr.csstransitions ? r.find(".bg-image").addClass("show") : $$.animation_started || r.find(".bg-image").animate({
        opacity: "show"
      }, 300, function() {
        return $(this).addClass("show")
      })), Modernizr.csstransitions ? $$.body.attr("class", n) : (n = $$.sections[e].rgb, $$.animation_started || ($$.animation_started = !0, $$.body.animate({
        backgroundColor: n
      }, 300, function() {
    ...
    set_active_section: function(e) {
      $(".section.fixed").removeClass("fixed"), $(".section").eq(e).addClass("fixed"), $(".site-link.selected").removeClass("selected"), $(".site-nav li:not(:has(#freddie))").eq(e).find(".site-link").addClass("selected")
    },
    hash_section_present: function() {
      var e, t;
      if ($$.hash && $$.hash[1] === "!") return e = $$.hash.split("/"), t = $(".section#section-" + e[2]), e[1] === "section" && t.length ? !0 : !1
    },
    get_hash_section: function() {
      var e, t;
      if ($$.hash_section_present()) {
        e = $$.hash.split("/"), t = $(".section#section-" + e[2]);
        if (t.length) return t
      }
    },
    init_sticky: function() {
      var e, t, n, r, i;
      n = $(".masthead").offset().top + $(".masthead").outerHeight(), t = Math.ceil($("footer").offset().top), e = $(".site-nav, .section.first"), i = $(window).scrollTop(), r = i + $(window).height(), i >= n ? e.hasClass("relative") && e.removeClass("relative") : e.addClass("relative"), r >= t ? ($(".site-nav").addClass("bottom-relative"), $(".section.last").addClass("relative")) : ($(".section.last").removeClass("relative"), $(".site-nav").removeClass("bottom-relative"))
    },
    navigation_to_section: function(e, t) {
      var n, r, i, s;
      return n = $(".site-link.selected").parent("li").index(), i = e === "next" ? n + 1 : n - 1, s = $(".masthead, .section"), r = s.eq(i), e === "prev" && n === 0 || e === "next" && n < 0 ? t.preventDefault() : $$.body.scrollTo(r, {
        duration: 450
      })
    },
    track_vpv: function(e) {
      return _gaq.push(["_trackPageview", "/vpv/2012-annual-report/" + e])
    },
    seconds_scrolling: function() {
      var e;
      return e = (new Date).getTime(), $$.total_time = e - $$.start_time, Math.round($$.total_time / 100) / 10
    }
  }, $(document).ready(function() {
    return $$.body = $("body"), Modernizr.svg || $("img").each(function() {
      var e;
      return e = $(this).attr("src"), $(this).attr("src", e.replace(".svg", ".png"))
    }), $(".masthead figure.freddie-back").backstretch($(".masthead figure.freddie-back img").attr("src")), $("footer figure.freddie-wave").backstretch($("footer figure.freddie-wave img").attr("src")), Modernizr.backgroundsize || $(".bg-image").each(function() {
      var e, t;
      return e = $(this), t = e.css("backgroundImage").replace(/url\("|"\)/gi, ""), e.backstretch(t)
      ...
      var n, r;
      return t === "down" ? n = $(this).parents(".section").prev() : n = $(this).parents(".section"), r = n.find(".section-title").html(), typeof r != "undefined" && _gaq.push(["_trackEvent", "2012 Annual Report", "View Section", r, $$.seconds_scrolling()]), $$.start_time = (new Date).getTime()
    }, {
    ...
    return $(".section").each(function(e, t) {
      return t = $(t), $$.sections.push({
        el: t,
        color: t.attr("data-color"),
        rgb: t.css("backgroundColor")
      }), t.css("background", "transparent")
    }), $.waypoints.settings.scrollThrottle = 0, $(".section .content").waypoint(function(e, t) {
      var n;
      n = $(this).parent(".section"), t === "up" && n.index() > 0 && (n = n.prev()), $$.can_animate_background && ($$.set_active_section(n.index()), $$.animate_background(n.index())), n.attr("id") === "section-footer" && $(".site-nav").fadeOut();
      if (t === "up") return $(".site-nav").fadeIn()
    }, {
      offset: 400,
      continuous: !1
    }), $$.hash_section_present() ? ($(".bg-image").removeClass("show"), $$.can_animate_background = !1, e = $$.get_hash_section(), $$.set_active_section(e.index()), $$.animate_background(e.index()), $(window).scrollTo(e.find(".content"), {
      duration: 1e3,
      onAfter: function() {
        return $$.can_animate_background = !0
      }
    })) : $$.body.css("backgroundColor", $$.sections[0].colour), $(".site-nav .site-link:not(#freddie)").click(function(e) {
      var t, n, r;
      return e.preventDefault(), r = $(this), t = r.attr("href"), n = r.parent("li").index() - 1, $$.can_animate_background = !1, $("body, .bg-image").addClass("no-transition"), $$.animate_background(n), $$.set_active_section(n), $("body").scrollTo(t, {
        duration: 1e3,
        offset: {
          top: 50
        },
        onAfter: function() {
          return window.location.hash = "!/section/" + t.replace("#section-", ""), $("body, .bg-image").removeClass("no-transition"), $$.can_animate_background = !0
        }
      })
    }), $("#freddie").click(function(e) {
      return e.preventDefault(), $$.animate_background(0), $$.set_active_section(0), $$.can_animate_background = !1, $$.body.scrollTo("#top", {
        duration: 1e3,
        onAfter: function() {
          return window.location.hash = "", $$.can_animate_background = !0
        }
      })
    }), $$.hash_section_present() || $$.init_sticky(), $(window).bind("scroll", function() {
      return $$.init_sticky()
    }), $(window).height() > 900 && $("footer").css("height", $(window).height()), $(window).resize(function() {
      if ($(window).height() > 900) return $("footer").css("height", $(window).height())
      ...
      var e, t;
      return t = $(this), e = t.parents("dd"), t.mouseenter(function(n) {
        return e.find(".bar-section.show").removeClass("show"), e.find("li.show").removeClass("show"), e.find('*[data-industry="' + t.attr("data-industry") + '"]').addClass("show")
      })
    }), $("#section-geography ul li a").each(function() {
      var e, t, n;
      return n = $(this), e = $(this).attr("data-country"), t = $("#section-geography .map"), n.mouseenter(function() {
        return t.find(".country.show").removeClass("show"), t.find(".country." + e).addClass("show")
